...
// Aree scorporate da questo file, che era arrivato a 3.313 righe. Ogni modulo
// e' autonomo e testabile per conto suo: vedi api/lib/admin/.
import { runSafeSelectQuery } from './lib/admin/sqlEditor.js'
import {
  getFeedback, azFeedbackMarcaGestito,
  getBanners, azBannerCrea, azBannerDisattiva, azBannerElimina,
} from './lib/admin/feedbackBanner.js'
import { getStripe } from './lib/admin/stripeClient.js'
import { getStripeMrr, getStripeEvents } from './lib/admin/stripeReport.js'
import {
...
import { getAiTelemetry } from './lib/admin/telemetriaAi.js'
import { getCronStatus, getHealthSnapshot } from './lib/admin/salute.js'
import { getSecuritySnapshot } from './lib/admin/sicurezzaPannello.js'
import { getUsageStats } from './lib/admin/usoPagine.js'
