...
const INTEGRAZIONI_CFG = [
  ...
  },
  {
    ...
    icona: 'store',
    categoria: 'Cassa',
    descrizione: 'Casse fiscali telematiche RCH. Chiusura giornaliera in CSV via USB o memoria interna.',
    istruzioni: [
  ...
  },
  {
    ...
    icona: 'store',
    categoria: 'Cassa',
    descrizione: 'Casse fiscali Olivetti. Export TXT/CSV con etichette in MAIUSCOLO.',
    istruzioni: [
  ...
  },
  {
    ...
    icona: 'store',
    categoria: 'Cassa',
    descrizione: 'Telematici fiscali Custom (Q3X) ed Epson (FP-90 III). CSV minimal con header lowercase.',
    istruzioni: [
      'Custom Q3X: Menu Gestore → Esporta XML/CSV → Vendite del giorno',
      'Epson FP-90: utility Epson → Export movimenti',
      'Carica il file qui',
    ],
    tipoFile: '.csv',
    tipoLabel: 'CSV',
  ...
  },
  {
    ...
    icona: 'store',
    categoria: 'Cassa',
    descrizione: 'Casse fiscali Salvi (forte presenza nel food sud Italia). Export CSV scontrini.',
    istruzioni: [
      'Software Salvi → Gestione → Esporta vendite CSV',
      'Carica qui',
    ],
    tipoFile: '.csv',
    tipoLabel: 'CSV',
  ...
  },
  {
    ...
    icona: 'store',
    categoria: 'Cassa',
    descrizione: 'Casse Indaco diffuse nel nord Italia per pasticcerie/gelaterie.',
    istruzioni: [
      'Indaco Manager → Report Scontrini → CSV',
      'Carica qui',
    ],
    tipoFile: '.csv',
    tipoLabel: 'CSV',
  ...
  },
  {
    ...
    icona: 'store',
    categoria: 'Cassa',
    descrizione: 'Cassa touch italiana popolare in bar e gelaterie. CSV chiusura giornaliera.',
    istruzioni: [
      'Polotouch → Pannello amministrazione → Esporta vendite',
      'Carica il file qui',
    ],
    tipoFile: '.csv',
    tipoLabel: 'CSV',
  ...
  },
  {
    ...
    icona: 'store',
    categoria: 'Cassa',
    descrizione: 'Cassa touch Eko (gruppo Diepoint). Export scontrini in CSV.',
    istruzioni: [
      'Eko Manager → Statistiche → Export CSV vendite',
      'Carica qui',
    ],
    tipoFile: '.csv',
    tipoLabel: 'CSV',
  ...
  },
  {
    ...
    icona: 'store',
    categoria: 'Cassa',
    descrizione: 'Wolf POS (ristoranti/bar). Export giornaliero in CSV.',
    istruzioni: [
      'Wolf Cloud → Report → Vendite → Esporta CSV',
      'Carica qui',
    ],
    tipoFile: '.csv',
    tipoLabel: 'CSV',
  ...
  {
    id: 'pos_universal',
    nome: 'Cassa generica (qualunque marca)',
    icona: 'bolt',
    categoria: 'Cassa',
