...
const P = {
  ...
  // Meteo: servono per la previsione della domanda, dove il tempo che farà è
  // il dato più importante per una gelateria. Prima erano emoji (☀️ ⛅ 🌧️),
  // contro la regola del progetto e con forme diverse su ogni dispositivo.
  nuvola:     '<path d="M18 16.5a3.5 3.5 0 0 0-.5-6.96A5.5 5.5 0 0 0 6.5 11 4 4 0 0 0 7 19h11a2.5 2.5 0 0 0 0-2.5z"/>',
  pioggia:    '<path d="M18 14.5a3.5 3.5 0 0 0-.5-6.96A5.5 5.5 0 0 0 6.5 9 4 4 0 0 0 7 17h11a2.5 2.5 0 0 0 0-2.5z"/><line x1="8" y1="19" x2="7" y2="22"/><line x1="12" y1="19" x2="11" y2="22"/><line x1="16" y1="19" x2="15" y2="22"/>',
  temporale:  '<path d="M18 12.5a3.5 3.5 0 0 0-.5-6.96A5.5 5.5 0 0 0 6.5 7 4 4 0 0 0 7 15h11a2.5 2.5 0 0 0 0-2.5z"/><polyline points="12 16 10 20 13 20 11 23"/>',
  nebbia:     '<line x1="3" y1="9" x2="21" y2="9"/><line x1="5" y1="13" x2="19" y2="13"/><line x1="3" y1="17" x2="17" y2="17"/>',
