...
export const SEZIONI = {
  ...
  'Listino (formati di vendita)': ['src/components/FormatiVendita.jsx'],
  ...
  'Inventario settimanale': ['src/views/InventarioSettimanaleView.jsx'],
  ...
  'Sprechi e omaggi': ['src/components/SpreciOmaggi.jsx'],
  ...
  'Vendite B2B': ['src/views/VenditeB2BView.jsx'],
